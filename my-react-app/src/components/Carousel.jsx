    ...
    render() {
        ...
        return (
            <div id="carousel" className="carousel slide" data-bs-ride="carousel">
                ...
                <button className="carousel-control-prev" onClick={this.prevSlide} data-bs-target="#carousel" type="button" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span className="visually-hidden">Previous</span>
                </button>

                <button className="carousel-control-next" onClick={this.nextSlide} data-bs-target="#carousel" type="button" data-bs-slide="next">
